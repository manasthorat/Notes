# AWS Configuration
ACCOUNT_ID = "7080374174212"  # Your account ID
REGION = "ap-south-1"  # Your region
BUCKET_1_NAME = "manaskawstestbucket1"  # Your Bucket-1 name
ROLE_1_ARN = f"arn:aws:iam::7080374174212:role/S3-Application-Role"
ROLE_2_ARN = f"arn:aws:iam::7080374174212:role/S3-Replication-Role"
