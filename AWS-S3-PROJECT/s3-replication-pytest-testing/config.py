...
ROLE_3_ARN = f"arn:aws:iam::708037417421:role/S3-AccessPoint-Role"
Replica_access_point_arn = f"arn:aws:s3:ap-south-1:708037417421:accesspoint/bucket2-access-point"
